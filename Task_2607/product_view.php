  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
          ...
          <?php if ($this->user->hasPermission('modify', 'total/total')) { ?> 
          <a onclick="$('#form').submit();" class="button"><?php echo $button_save; ?></a>
          <?php } ?>
          <a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><?php if ($this->user->hasPermission('modify', 'total/total')) { ?> <a style="background: #F8ACAC; color:white;" href="#tab-price">Pricing</a> <?php } ?><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-combo">Combo</a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-profile"><?php echo $tab_profile; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab-fg-contents">BOM</a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                    <td>Ingredients</td>
                    <td>
                        <textarea name="product_description[<?php echo $language['language_id']; ?>][ingredients]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['ingredients'] : ''; ?></textarea>
                    </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>Source of Origin</td>
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][source_of_origin]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['source_of_origin'] : ''; ?>" /></td>
              </tr>
            </table>
          </div>
          <?php } ?>
        ...
        <div id="tab-price">
          <table class="form">
          <tr> 
                <td>Cost<span class="help">(For all except FG & Combo)</span></td>
                <td><input type="text" name="cost" value="<?php echo $cost; ?>" /></td>
            </tr>
            
            <tr>
                <td>MRP</td>
                <td><input type="text" name="mrp2" value="<?php echo $mrp2; ?>" /></td>
            </tr>
            <tr>
                <td><?php echo $entry_price; ?><span class="help">(Without Tax)</span></td>
                <td><input type="text" name="price" value="<?php echo $price; ?>" /></td>
            </tr>
            <tr>
                <td>Offline Selling Price<span class="help">(Without Tax)</span></td>
                <td><input type="text" name="offline_sp" value="<?php echo $offline_sp; ?>" />
                <?php if ($error_offline_sp) { ?>
                    <span class="error"><?php echo $error_offline_sp; ?></span>
                <?php } ?>
                </td>
            </tr>
            <tr>
                <td>Online Selling Price<span class="help">(Without Tax)</span></td>
                <td><input type="text" name="online_sp" value="<?php echo $online_sp; ?>" />
                <?php if ($error_online_sp) { ?>
                    <span class="error"><?php echo $error_online_sp; ?></span>
                <?php } ?>
                </td>
            </tr>
          </table>
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <td><input type="text" name="model" value="<?php echo $model; ?>" /><?php if ($error_model) { ?>
            ...
            <tr>
              <td>FSN</td>
              <td><input type="text" name="flipkart_fsn" value="<?php echo $flipkart_fsn; ?>" /></td>
            </tr> 
            <tr>
              <td>Rack No.:<br/><span class="help">Rack number of product</span></td>
              <td><input type="text" name="rack_no" value="<?php echo $rack_no; ?>" /></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="text" name="quantity" value="<?php echo $quantity; ?>" size="6" /></td>
            </tr>
            
            <tr>
              <td><?php echo $text_min_stock; ?></td>
              <td><input type="text" name="min_stock" value="<?php echo $min_stock; ?>" size="6" /></td>
            </tr>
            
            <tr>
              <td><?php echo $text_fba_min_stock; ?></td>
              <td><input type="text" name="fba_min_stock" value="<?php echo $fba_min_stock; ?>" size="6" /></td>
            </tr>
            ...
            <tr>
              <td><?php echo $entry_gross_weight; ?></td>
              <td><input type="text" name="gross_weight" value="<?php echo $gross_weight; ?>" />
               </td>
            </tr>            
            <tr>
         ...
         <tr>
             ...
             <tr>
              <td><?php echo $entry_product_packingtype; ?></td>
              <td><input type="text" name="product_packingtype" value="<?php echo $product_packingtype; ?>" />
               </td>
            </tr>
            
            <tr>
              <td><?php echo $entry_casepacking_pid; ?></td>
              <td><input type="text" name="casepacking_pid" value="<?php echo $casepacking_pid; ?>" />
               </td>
            </tr>
            
            
            <tr>
                <td>Shelf Life (In Days)</td>
                <td><input type="text" name="shelf_life" value="<?php echo $shelf_life; ?>" /></td>
            </tr>
            
            <tr>
                <td>Case Quantity</td>
                <td><input type="text" name="case_quantity" value="<?php echo $case_quantity; ?>" /></td>
            </tr>
            
            <tr>
                <td>TE.com URL</td>
                <td><input type="text" name="te_com_url" value="<?php echo $te_com_url; ?>" /></td>
            </tr>
            
            <tr>
                <td>Front Quantity<br/><span class="help">For Primary Deck</span></td>
                <td><input type="text" name="front_quantity" value="<?php echo $front_quantity; ?>" size="6" /></td>
            </tr>
            
            <tr>
                <td>Millet Based Product</td>
                <td>
                    <select name="millet_product">
                        <option value="1" <?php if($millet_product == "1") { echo 'selected'; } ?>>Yes</option>
                        <option value="0" <?php if($millet_product == "0") { echo 'selected'; } ?>>No</option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>		
		            <select style = "width:100px;" name="product_type" >
		                <option>Select Type</option>
		                    <?php foreach($product_types as $type) { ?>
		                        <?php if($product_type == $type['type_id']) { ?>
            ...
            <tr>
              <td>Front End Status:</td>
              <td><select name="front_status">
                  <?php if ($front_status) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
    ...
    <div id="tab-fg-contents">      
  <table class="form">
    <tr>
      <td><?php echo "RM/PM list"; ?></td>
      <td><input type="text" name="sub_product_name" value="" placeholder = "Enter Product Id OR RM/PM Name & Select (Autocomplete)" size="100" /></td>
    </tr>
    <tr>
      <td></td>
      <td>          
        <table id="selections" class="list">
          <thead>
            <tr>
              <td class="center"><?php echo "Product Id"; ?></td>
              <td class="left"><?php echo "Product Name"; ?></td>                
              <td class="center"><?php echo "QTY(1.000gm as 1kg / 0.050gm as 50gm)"; ?></td>        
              <td></td>
            </tr>
          </thead>
          <?php $bom_row = 0; ?>
          <?php foreach ($product_selected as $subproduct) { ?>
            <tbody id="product-row<?php echo $bom_row; ?>">
              <tr>
                <td class="center">
                  <input type="text" name="sub_product_list[<?php echo $bom_row; ?>][rmpm_id]" value="<?php echo $subproduct['rmpm_id']; ?>" size="5" />
                </td>
                
                <td class="left">
                  <input type="text" name="sub_product_list[<?php echo $bom_row; ?>][rmpm_name]" value="<?php echo $subproduct['rmpm_name']; ?>" size="100" />
                </td>            
                
                <td class="center">
                  <input type="text" name="sub_product_list[<?php echo $bom_row; ?>][quantity]" value="<?php echo $subproduct['quantity']; ?>" size="3" />
                </td>
                
                <td class="center">
                  <a onclick="$('#product-row<?php echo $bom_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a>
                </td>
    ...
    <!-- END SUB Products -->   
        ...
        <div id="tab-combo">
            <table class="form"> 
	        <tr>
		        <td><?php echo "Combo product list"; ?></td>
		        <td><input type="text" name="combo" value="" placeholder = "Enter Product Name & Select (Autocomplete)" size="100" /></td> 
	        </tr>
			 
        	<tr>
                <td></td>
                    <td>
                		<table id="combos" class="list">
                			<thead>
                              <tr>
                                <td class="left"><?php echo "Product Name"; ?></td>
                                <td class="center"><?php echo "Product Id"; ?></td>
                				<td class="center"><?php echo "Deduct"; ?></td>
                                <td></td>
                              </tr>
                            </thead>
                			
                            <?php $combo_row = 0; ?>
                            <?php foreach ($product_combos as $product) { ?>
                
                            <tbody id="product-row<?php echo $combo_row; ?>">
                		        <tr>
                            	    <td class="left"><input type="text"  name="product_combo[<?php echo $combo_row; ?>][name]" value="<?php echo $product['name']; ?>" class="form-control" /></td>
                            	    
                            	    <td class="left"><input type="text"  name="product_combo[<?php echo $combo_row; ?>][product_id]" value="<?php echo $product['product_id']; ?>" class="form-control" /></td>  
                            	    
                            	    <td class="center"><input type="text" name="product_combo[<?php echo $combo_row; ?>][deduct]" value="<?php echo $product['deduct']; ?>" size="2" /></td>
                            	    
                            	    <td class="left"><a onclick="$('#product-row<?php echo $combo_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
                		        </tr>
                	        </tbody>
       ...
       <!--Tab Combo-->
        ...
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              <td>Quick Category</td>
              <td>
                  <select name="quick_category">
                      <option value="">Select Quick Category</option>
                      <?php foreach($quick_categories AS $quick_category_data) { ?>
                        <?php if($quick_category_data['name'] == $quick_category) { ?>
                            <option value="<?php echo $quick_category_data['name']; ?>" selected><?php echo $quick_category_data['name']; ?></option>
                        <?php } else { ?>
                            <option value="<?php echo $quick_category_data['name']; ?>"><?php echo $quick_category_data['name']; ?></option>
                        <?php } ?>
                      <?php } ?>
                  </select>
              </td>
            ...
            <tr>
              <td>Offline Zone<br/><span class="help">(Autocomplete)</span></td>
              <td><input type="text" name="zone" value="" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><div id="product-zone" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($product_zones as $product_zone) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-zone<?php echo $product_zone['zone_id']; ?>" class="<?php echo $class; ?>"><?php echo $product_zone['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="product_zone[]" value="<?php echo $product_zone['zone_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              <thead>
                <tr>
                  ...
                  <?php if ($product_option['option_id'] == '25') { ?>
                    <td class="left">Manufacturing Date</td>
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  <td class="left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]">
                    ...
                    <?php if ($product_option['option_id'] == '25') { ?>
                        <td class="right"><?php echo $product_option_value['manufacturing_date']; ?></td>
                        <td class="right"><?php echo $product_option_value['days_diff']; ?></td>
                    <?php } ?>
...
$('input[name=\'combo\']').autocomplete({
	...
	select: function(event, ui) {
		html  = '<tbody id="product-row' + combo_row + '">';
		html += '<tr>';
	
		html += '<td class="left">';
        html += '<input type="text"  name="product_combo[' + combo_row + '][name]" value="' + ui.item.label + '" class="form-control" />';
        html += '   </td>';
        
        html += '<td class="left">';
        html += '<input type="text"  name="product_combo[' + combo_row + '][product_id]" value="' + ui.item.value + '" class="form-control" />';
        html += '   </td>';      
	
		html += '<td class="center"><input type="text" name="product_combo[' + combo_row + '][deduct]" value="1" size="2" /></td>';
		
		html += '<td class="left"><a onclick="$(\'#product-row' + combo_row  + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
		html += '  </tr>';
		html += '</tbody>';
		
		$('#combos tfoot').before(html);
...
$('input[name=\'zone\']').autocomplete({
	...
	select: function(event, ui) {
		$('#product-zone' + ui.item.value).remove();
		
		$('#product-zone').append('<div id="product-zone' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="product_zone[]" value="' + ui.item.value + '" /></div>');

		$('#product-zone div:odd').attr('class', 'odd');
		$('#product-zone div:even').attr('class', 'even');
...
$('#product-zone div img').live('click', function() {
	$(this).parent().remove();
...
function addOptionValue(option_row) {	
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value_id]" class="search-dropdown">';
...
<script type="text/javascript"><!--
  var bom_row = <?php echo $bom_row; ?>;
  $('input[name=\'sub_product_name\']').autocomplete({
    delay: 500,
    ...
    select: function(event, ui) {
      html  = '<tbody id="product-row' + bom_row + '">';
      html += '<tr>';
      
      html += '<td class="center">';
      html += '<input type="text"  name="sub_product_list[' + bom_row + '][rmpm_id]" value="' + ui.item.value + '" class="form-control" size = "5" />';
      html += '   </td>';

      html += '<td class="left">';
      html += '<input type="text"  name="sub_product_list[' + bom_row + '][rmpm_name]" value="' + ui.item.label + '" class="form-control" size = "100"/>';
      html += '   </td>'; 
      

      html += '<td class="center"><input type="text" name="sub_product_list[' + bom_row + '][quantity]" value="" placeholder = "0.000" size="3" /></td>';

      html += '<td class="center"><a onclick="$(\'#product-row' + bom_row  + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
      
      html += '  </tr>';
      
      html += '</tbody>';

      $('#selections tfoot').before(html);
