      ...
      <?php if ($success) { ?>
        ...
        <?php if($email != '') { ?>
            ...
            <div class="form-group">
               <div class="col-sm-1 col-xs-1 col-md-1"></div>       
               <div class="col-sm-10 col-xs-10 col-md-10">
                    <input type="text" class="form-control" name="firstname" placeholder="Contact Person Firstname *" value="<?php echo $firstname; ?>" />
            ...
            <div class="form-group">
               <div class="col-sm-1 col-xs-1 col-md-1"></div>       
               <div class="col-sm-10 col-xs-10 col-md-10">          
                     <input type="text" class="form-control" name="lastname" placeholder="Contact Person Lastname *" value="<?php echo $lastname; ?>" />
            ...
            <div class="form-group">
                <div class="col-sm-1 col-xs-1 col-md-1"></div>       
                <div class="col-sm-10 col-xs-10 col-md-10">
                    <input type="text" class="form-control" name="email" placeholder="<?php echo $entry_email; ?> *" value="<?php echo $email; ?>" style="pointer-events: none;" />
                    <?php if ($error_email) { ?>
            ...
            <div class="form-group">
               <div class="col-sm-1 col-xs-1 col-md-1"></div>       
               <div class="col-sm-10 col-xs-10 col-md-10">          
                    <input type="text" class="form-control" name="telephone" placeholder="Mobile *"  value="<?php echo $telephone; ?>" />
            ...
            <div class="form-group">
               <div class="col-sm-1 col-xs-1 col-md-1"></div>      
               <div class="col-sm-10 col-xs-10 col-md-10">          
                    <input type="text" class="form-control" name="tax_id" placeholder="GST ID *" value="<?php echo $tax_id; ?>" maxlength="15" />
                        <?php if ($error_tax_id) { ?>
            ...
            <div class="form-group">
                <div class="col-sm-1 col-xs-1 col-md-1"></div>      
                <div class="col-sm-10 col-xs-10 col-md-10">          
                    <input type="text" class="form-control" name="pan_number" placeholder="PAN Number *" value="<?php echo $pan_number; ?>" maxlength="10" />
                        <?php if ($error_pan_number) { ?>
                            <span class="error"><?php echo $error_pan_number; ?></span>
                        <?php } ?>
                </div>
                <div class="col-sm-1 col-xs-1 col-md-1"></div>       
            </div>
            <div class="form-group">
                <div class="col-sm-1 col-xs-1 col-md-1"></div>      
                <div class="col-sm-10 col-xs-10 col-md-10">          
                    <input type="text" class="form-control" name="fssai" placeholder="FSSAI Licence Number" value="<?php echo $fssai; ?>" maxlength="14" />
                </div>
                <div class="col-sm-1 col-xs-1 col-md-1"></div>       
            </div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-1 col-xs-1 col-md-1"></div>
                <div class="col-sm-10 col-xs-10 col-md-10">
                    <a id="button-gst-certificate-upload" class="btn btn-info button">* Upload GST Certificate</a><span id="upload-msg-gst"><?php echo substr($gst_doc, 37); ?></span>
            ...
            <div class="form-group">
                <div class="col-sm-1 col-xs-1 col-md-1"></div>
                <div class="col-sm-10 col-xs-10 col-md-10">
                    <a id="button-fssai-certificate-upload" class="btn btn-info button">Upload FSSAI Certificate</a><span id="upload-msg-fssai"><?php echo substr($fssai_doc, 39); ?></span>
            ...
            <div class="form-group" align="center">        
                <div class="col-sm-1 col-xs-1 col-md-1"></div> 
                <div class="col-sm-10 col-xs-10 col-md-10">
                    <button type="submit" class="btn btn-default <?php if($agree != 1) { echo 'disabled'; } ?>" id="btn-submit">Submit</button>
        ...
        <?php } else { ?>
            <div class="heading">
                <h1 class="title">Generate Registration Link</h1>
            </div>
            <form action="<?php echo $action; ?>" class="form-horizontal" method="post" enctype="multipart/form-data" align="center">
                <div class="form-group">
                    <div class="col-sm-1 col-xs-1 col-md-1"></div>       
                    <div class="col-sm-10 col-xs-10 col-md-10">
                        <input type="text" class="form-control" name="email" placeholder="<?php echo $entry_email; ?> *" value="<?php echo $email; ?>" />
                    </div>
                    <div class="col-sm-1 col-xs-1 col-md-1"></div>
                </div>
                ...
                <?php if ($offline_user_id) { ?>
                    <div class="form-group" align="center">
                        <div class="col-sm-12 col-xs-12 col-md-12">
                            <a class="btn btn-info" id="btn-generate-link" style="margin-top: 15px;">Generate Registration Link</a>
                        </div>
                    </div>
                <?php } else { ?>
                    <div class="form-group" align="center">
